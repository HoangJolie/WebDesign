...
<link href="{{asset('FE/css/bootstrap.css')}}" rel="stylesheet" type="text/css" media="all" />
<link href="{{asset('FE/css/style.css')}}" rel="stylesheet" type="text/css" media="all" />
<link href="{{asset('FE/css/font-awesome.css')}}" rel="stylesheet"> 
<script src="{{asset('FE/js/jquery-1.11.1.min.js')}}"></script>
<link href='//fonts.googleapis.com/css?family=Raleway:400,100,100italic,200,200italic,300,400italic,500,500italic,600,600italic,700,700italic,800,800italic,900,900italic' rel='stylesheet' type='text/css'>
<link href='//fonts.googleapis.com/css?family=Open+Sans:400,300,300italic,400italic,600,600italic,700,700italic,800,800italic' rel='stylesheet' type='text/css'>
<script type="text/javascript" src="{{asset('FE/js/move-top.js')}}"></script>
<script type="text/javascript" src="{{asset('FE/js/easing.js')}}"></script>
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
			...
			<div class="w3ls_logo_products_left">
				<h1><a href="{{Route('HOMEPAGE')}}">super Market</a></h1>
			</div>
	...
	<div class="footer-botm">
			<div class="container">
				...
				<div class="payment-w3ls">	
					<img src="{{asset('FE/images/card.png')}}" alt=" " class="img-responsive">
				</div>
				<div class="clearfix"> </div>
			</div>
		</div>
...
<script src="{{asset('FE/js/minicart.min.js')}}"></script>
<script>
	// Mini Cart
...
<!-- main slider-banner -->
<script src="{{asset('FE/js/skdslider.min.js')}}"></script>
<link href="{{asset('FE/css/skdslider.css')}}" rel="stylesheet">
<script type="text/javascript">
		jQuery(document).ready(function(){
